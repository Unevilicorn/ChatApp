...
{
    public class MongoDbChatAppDbSchemaMigrator : IChatAppDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbChatAppDbSchemaMigrator(IServiceProvider serviceProvider)
        {
